local Translations = {
    error = {
        ...
        no_ammo = 'You don\'t have any %s for your weapon.',
        full_ammo = 'Your weapon is already full ammo.',
        no_support_attachment = 'This weapon does not support this attachment.',
        no_weapon_in_hand = 'You dont have a weapon in your hand.',
        weapon_no_match = 'Equipped weapon doesn\'t match the weapon when you started reloading',
    ...
    info = {
        reloading_bullets = 'Reloading %s Bullets...',
